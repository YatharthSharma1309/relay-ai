...
-- CreateEnum
CREATE TYPE "MemberRole" AS ENUM ('ADMIN', 'AGENT');

-- CreateEnum
CREATE TYPE "ConversationChannel" AS ENUM ('ADMIN', 'WIDGET', 'HELP_CENTER');
...
CREATE TABLE "Conversation" (
    ...
    "organizationId" TEXT NOT NULL,
    "visitorId" TEXT,
    "channel" "ConversationChannel" NOT NULL DEFAULT 'ADMIN',
    "title" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Organization_widgetPublicKey_key" ON "Organization"("widgetPublicKey");
...
-- CreateIndex
CREATE INDEX "Conversation_organizationId_visitorId_idx" ON "Conversation"("organizationId", "visitorId");
